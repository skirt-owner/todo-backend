...
The API documentation can be found in the [API Documentation](https://github.com/skirt-owner/todo-backend/tree/main/docs) file. It contains detailed information about each API endpoint, request formats, and response formats.
